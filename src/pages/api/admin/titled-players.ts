...
export default async function handler(
  ...
  // TODO: Verify admin authentication when auth module is available
...
async function handleGet(req: NextApiRequest, res: NextApiResponse, db: unknown) {
...
async function handlePost(req: NextApiRequest, res: NextApiResponse, db: unknown) {
...
async function handlePut(req: NextApiRequest, res: NextApiResponse, db: unknown) {
