...
export default async function handler(
  ...
  try {
    ...
    const newUser = { id: 1, username: data.username, email: data.email, titledPlayerVerified: data.titledPlayerVerified, titledPlayerTitle: data.titledPlayerDetails?.title, echoOrigin: data.echoOrigin, accountType: data.titledPlayerVerified ? 'premium_titled' : 'free' };
